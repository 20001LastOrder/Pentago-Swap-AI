...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "pentago_swap.RandomPentagoPlayer", "student_player.StudentPlayer_V4", "student_player.StudentPlayer_00" 
    													, "student_player.StudentPlayer_V0", "student_player.StudentPlayer_V3"};
